...
#
# Sourced from https://github.com/rgrp/csv2sqlite
...
def convert(filepath_or_fileobj, dbpath, table, headerspath_or_fileobj=None, compression=None, cursor=None):
...
def _guess_types(reader, number_of_columns, max_sample_size=100):
    ...
    results = [dict(perresult) for __ in range(number_of_columns)]
    sample_counts = [0 for __ in range(number_of_columns)]
